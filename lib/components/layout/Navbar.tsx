    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0d0b14]/80 backdrop-blur-xl border-b border-white/5">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link href={`/${currentLocale}`} className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-white/10 to-[#0ea5e9]/10 border border-white/20 flex items-center justify-center group-hover:border-[#0ea5e9]/40 transition-all duration-300">
            <Image
              src="/static/logo.png"
              alt="Logo"
              width={24}
        ...
        <div className="flex items-center gap-3">
          ...
          <div ref={langRef} className="relative">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm text-gray-400 hover:text-white transition-colors bg-white/5 border border-white/10 hover:border-[#0ea5e9]/40 rounded-lg"
            >
              <svg
                className="w-4 h-4"
                fill="none"
          ...
          {isAuthenticated && user ? (
            <div ref={userRef} className="relative">
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm text-gray-300 hover:text-white transition-colors bg-white/5 border border-white/10 hover:border-[#0ea5e9]/40 rounded-lg"
              >
                <div className="w-6 h-6 rounded-full bg-gradient-to-br from-white to-[#0ea5e9] flex items-center justify-center text-black font-medium text-xs">
            ...
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 hover:border-white/40 rounded-lg transition-all hover:bg-white/10 text-sm text-gray-300 hover:text-white"
            >
              <svg
